  ...
  render() {
    return (
      <div className="StudentBody mt-5  mb-5">
        <Container className="full-container ml-4 mr-4">
          <Row className="mb-4">
          ...
          <Row className="mb-2">
            ...
            <Col xs="15" lg="4" className="mb-2">
              <Player url="https://youtu.be/swh6Kp40J7s" />
            </Col>
            <Col xs="15" lg="4" className="mb-2">
          ...
          <Row className="mb-2">
            ...
            <Col xs="15" lg="4" className="mb-2">
              <Player url="https://youtu.be/wP66iDiQvNM" />
            </Col>
            <Col xs="15" lg="4" className="mb-2">
          ...
          <Row className="mb-2">
            ...
            <Col xs="15" lg="4" className="mb-2">
              <Player url="https://youtu.be/v27mnauBE18" />
            </Col>
            <Col xs="15" lg="4" className="mb-2">
